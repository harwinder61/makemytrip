                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title">Hotel List</h2>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">Search Hotels</h3>
        ...
        <div class="row">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="sidebar-widget-item">
                            <div class="contact-form-action">
                                <form action="#">
                                    <div class="input-box">
                                        <label class="label-text">Location / Property</label>
                                        <div class="form-group">
                                            <span class="la la-map-marker form-icon"></span>
                                            <input class="form-control" type="text" name="text" placeholder="Enter location or property name">
                                        </div>
                                    </div>
                                    <!-- <div class="input-box">
            ...
            <div class="col-lg-8">
                <div class="card-item card-item-list">
					...
					<h4><ins>₹ 4,500</ins></h4>
					<p>Avg/Night</p>
					<a href="http://arthtechsolutions.com/makemytrip/single-hotels">Select Room</a>
					</div>
                </div><!-- end card-item -->
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
