            ...
            <div class="row">
                <div class="col-lg-12 header-box">
                    <div class="menu-wrapper menu-box">
                        ...
                        <div class="logo">
                            <a href="http://arthtechsolutions.com/makemytrip//"><img src="{{asset('public/web/img/mazi.png')}} " alt="logo" class="img-fluid"></a>
                        ...
                        <div class="main-menu-content pages_list">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="http://arthtechsolutions.com/makemytrip//">Home</a>
                                    </li>
                                    <li>
                                        <a href="">Offer</a>
                                    ...
                                    <li>
                                        <a href="http://arthtechsolutions.com/makemytrip/about">About</a>
                                        
                                    </li>
                                    <li>
                                        <a href="http://arthtechsolutions.com/makemytrip/contact">Contact</a>
								    ...
								    <a href=""><i class="fa fa-sign-in" aria-hidden="true">
									</i>Login or Sign Up</a>
									</li>
                                </ul>
                            </nav>
